                    ...
                    <div class="col-12">
                        <form action="{{ route('admin.contact.replay', $contact->id) }}" method="post">
                            ...
                            @if ($contact->reason == 'Create New Group')
                                <select name="content"
                                    class="form-control w-50 bg-dark text-light h-100 m-auto text-center">
                                    <option value="Already Group Exits">Already Group Exists</option>
                                    <option value="We Are going to create it , thanks for your help us be better">Group Not
                                        Exist</option>
                                </select>
                            @elseif ($contact->reason == 'Create New Category')
                                <select name="content"
                                    ...
                                    <option value="We Are going to create it , thanks for your help us be better">Category
                                        Not Exist</option>
                                </select>
                            @else
                                ...
                                @enderror
                            @endif
                            <input type="submit" class="btn btn-sm btn-dark mt-3 text-light" style="float: right"
                                value="Replay">
                        </form>
